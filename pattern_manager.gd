...
func _create_patterns():
	...
	pattern1.obstacles.append(ObstaclePattern.ObstacleData.new(400))
	...
	pattern2.obstacles.append(ObstaclePattern.ObstacleData.new(200))
	...
	pattern3.obstacles.append(ObstaclePattern.ObstacleData.new(300))
	...
	pattern4.obstacles.append(ObstaclePattern.ObstacleData.new(120, 0.0, 80.0))
	pattern4.obstacles.append(ObstaclePattern.ObstacleData.new(480, 0.0, 80.0))
	...
	pattern5.obstacles.append(ObstaclePattern.ObstacleData.new(450, 0.0, 80.0))
	pattern5.obstacles.append(ObstaclePattern.ObstacleData.new(350, 150.0, 80.0))
	pattern5.obstacles.append(ObstaclePattern.ObstacleData.new(250, 300.0, 80.0))
	...
	pattern6.obstacles.append(ObstaclePattern.ObstacleData.new(150, 0.0, 80.0))
	pattern6.obstacles.append(ObstaclePattern.ObstacleData.new(250, 150.0, 80.0))
	pattern6.obstacles.append(ObstaclePattern.ObstacleData.new(350, 300.0, 80.0))
	...
	pattern7.obstacles.append(ObstaclePattern.ObstacleData.new(150, 0.0, 80.0))
	pattern7.obstacles.append(ObstaclePattern.ObstacleData.new(450, 120.0, 80.0))
	pattern7.obstacles.append(ObstaclePattern.ObstacleData.new(250, 240.0, 80.0))
	...
	pattern8.obstacles.append(ObstaclePattern.ObstacleData.new(100, 0.0, 120.0))
